...
class Program
{
    ...
    private async Task MainAsync()
    {
        ...
        // Get token from EnvironmentVariable DiscordToken
        // if token null or empty ask for new token and set the token as EnvironmentVariable
        
        // HACKNET
        // habe keine ahnung eiw environment variables richtig gehen...
        // der code hier fragt immer nach nem token...
